  ...
  >
    ...
    <div class="button-group">
      <div class="button townsfolk" @click="copy">
        <font-awesome-icon icon="copy" /> Kopijuoti JSON
      </div>
      <div class="button townsfolk" @click="toggleModal('generateGame')" v-if="!session.isSpectator">
        <font-awesome-icon icon="plus-circle" /> Generuoti žaidimą
      </div>
